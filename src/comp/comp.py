...
print("Starts with D:")
a = [human.name for human in humans if human.name[:1] == 'D']
print(a)
...
c = [human.name for human in humans  if 'C' <= human.name[:1] <= 'G']
print(c)
...
e = [human.name + "_" + str(human.age) for human in humans]
print(e)
